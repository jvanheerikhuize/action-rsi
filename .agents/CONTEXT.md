...
## Known Concerns
- [2026-04-12] Context builder producing completely incorrect dependency graph with non-existent file paths
- [2026-04-12] Import path mismatch between .js extensions in source and .ts actual files
- [2026-04-12] Lack of standardized error handling across action modules
